...
import 'r_t_b2_fill_product_copy_model.dart';
export 'r_t_b2_fill_product_copy_model.dart';

class RTB2FillProductCopyWidget extends StatefulWidget {
  const RTB2FillProductCopyWidget({
    super.key,
    required this.sku,
  ...
  static String routeName = 'RTB_2_FillProductCopy';
  static String routePath = '/rTB2FillProductCopy';

  @override
  State<RTB2FillProductCopyWidget> createState() =>
      _RTB2FillProductCopyWidgetState();
}

class _RTB2FillProductCopyWidgetState extends State<RTB2FillProductCopyWidget> {
  late RTB2FillProductCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RTB2FillProductCopyModel());
