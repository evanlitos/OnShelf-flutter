...
import 'r_t_b1_find_code_model.dart';
export 'r_t_b1_find_code_model.dart';

class RTB1FindCodeWidget extends StatefulWidget {
  const RTB1FindCodeWidget({super.key});

  static String routeName = 'RTB1_FindCode';
  static String routePath = '/rTB1FindCode';

  @override
  State<RTB1FindCodeWidget> createState() => _RTB1FindCodeWidgetState();
}

class _RTB1FindCodeWidgetState extends State<RTB1FindCodeWidget> {
  late RTB1FindCodeModel _model;
                                                  ...
                                                  if (_model.sinputSkuTextController
                                                    ...
                                                    if ((_model.resultadoSKU
                                                      ...
                                                      if (ProductsStruct.maybeFromMap((_model
                                                              ...
                                                              ?.notFound ==
                                                          false) {
                                                        _model.addToScanList(_model
                                                            .sinputSkuTextController
                                                            .text);
                                                        safeSetState(() {});

                                                        context.pushNamed(
                                                          RTB2FillProductCopyWidget
                                                              .routeName,
                                                          queryParameters: {
                                                            'sku':
                                                                serializeParam(
