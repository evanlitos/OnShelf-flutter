...
import 'success_register_products_copy_model.dart';
export 'success_register_products_copy_model.dart';

class SuccessRegisterProductsCopyWidget extends StatefulWidget {
  const SuccessRegisterProductsCopyWidget({
    super.key,
    this.aFoto,
    this.bFoto,
  });
  ...
  @override
  State<SuccessRegisterProductsCopyWidget> createState() =>
      _SuccessRegisterProductsCopyWidgetState();
}

class _SuccessRegisterProductsCopyWidgetState
    extends State<SuccessRegisterProductsCopyWidget> {
  late SuccessRegisterProductsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SuccessRegisterProductsCopyModel());
  }
