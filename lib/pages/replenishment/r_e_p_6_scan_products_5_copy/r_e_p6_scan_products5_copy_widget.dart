...
import 'r_e_p6_scan_products5_copy_model.dart';
export 'r_e_p6_scan_products5_copy_model.dart';

class REP6ScanProducts5CopyWidget extends StatefulWidget {
  const REP6ScanProducts5CopyWidget({
    super.key,
    required this.aFoto,
    required this.bFoto,
  });
  ...
  static String routeName = 'REP_6_ScanProducts_5Copy';
  static String routePath = '/rEP6ScanProducts5Copy';

  @override
  State<REP6ScanProducts5CopyWidget> createState() =>
      _REP6ScanProducts5CopyWidgetState();
}

class _REP6ScanProducts5CopyWidgetState
    extends State<REP6ScanProducts5CopyWidget> {
  late REP6ScanProducts5CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => REP6ScanProducts5CopyModel());
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final items =
                          FFAppState().toShelfSelected.products.toList();
