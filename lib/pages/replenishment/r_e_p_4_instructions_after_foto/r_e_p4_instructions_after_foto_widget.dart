...
import 'r_e_p4_instructions_after_foto_model.dart';
export 'r_e_p4_instructions_after_foto_model.dart';

class REP4InstructionsAfterFotoWidget extends StatefulWidget {
  const REP4InstructionsAfterFotoWidget({
    super.key,
    required this.bFoto,
  });
  ...
  static String routeName = 'REP_4_InstructionsAfterFoto';
  static String routePath = '/rEP4InstructionsAfterFoto';

  @override
  State<REP4InstructionsAfterFotoWidget> createState() =>
      _REP4InstructionsAfterFotoWidgetState();
}

class _REP4InstructionsAfterFotoWidgetState
    extends State<REP4InstructionsAfterFotoWidget> {
  late REP4InstructionsAfterFotoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => REP4InstructionsAfterFotoModel());
  }
