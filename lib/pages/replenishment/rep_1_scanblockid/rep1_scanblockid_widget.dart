...
import 'rep1_scanblockid_model.dart';
export 'rep1_scanblockid_model.dart';

class Rep1ScanblockidWidget extends StatefulWidget {
  const Rep1ScanblockidWidget({super.key});

  static String routeName = 'REP_1_SCANBLOCKID';
  static String routePath = '/rep1Scanblockid';

  @override
  State<Rep1ScanblockidWidget> createState() => _Rep1ScanblockidWidgetState();
}

class _Rep1ScanblockidWidgetState extends State<Rep1ScanblockidWidget> {
  late Rep1ScanblockidModel _model;
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  height: valueOrDefault<double>(
                                    FFAppState().toShelfSelected.mapCanvaId != 0
                                        ? 150.0
                                        : 0.0,
                                    0.0,
                                  ),
                                                      ...
                                                      builder: (dialogContext) {
                                                        return Dialog(
                                                          ...
                                                          child:
                                                            ...
                                                            child:
                                                                NoFoundWidget(
                                                              display: ShelfsStruct
                                                                      .maybeFromMap(
                                                                          (_model.apiResultmny?.jsonBody ??
                                                                              ''))
                                                                  ?.mapCanvaId
                                                                  .toString(),
                                                            ),
