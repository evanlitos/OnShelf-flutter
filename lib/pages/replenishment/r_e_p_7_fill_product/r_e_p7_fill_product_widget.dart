...
import 'r_e_p7_fill_product_model.dart';
export 'r_e_p7_fill_product_model.dart';

class REP7FillProductWidget extends StatefulWidget {
  const REP7FillProductWidget({
    super.key,
    this.product,
  ...
  static String routeName = 'REP_7_FillProduct';
  static String routePath = '/rEP7FillProduct';

  @override
  State<REP7FillProductWidget> createState() => _REP7FillProductWidgetState();
}

class _REP7FillProductWidgetState extends State<REP7FillProductWidget> {
  late REP7FillProductModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => REP7FillProductModel());
                                    ...
                                    Expanded(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            'COF: ${widget.product?.cof.toString()}',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font:
                                          ...
                                          Text(
                                            'MARQ: ${widget.product?.ctn.toString()}',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font:
