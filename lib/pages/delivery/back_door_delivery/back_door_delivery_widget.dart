...
import 'back_door_delivery_model.dart';
export 'back_door_delivery_model.dart';

class BackDoorDeliveryWidget extends StatefulWidget {
  const BackDoorDeliveryWidget({super.key});

  static String routeName = 'BackDoorDelivery';
  static String routePath = '/backDoorDelivery';

  @override
  State<BackDoorDeliveryWidget> createState() => _BackDoorDeliveryWidgetState();
}

class _BackDoorDeliveryWidgetState extends State<BackDoorDeliveryWidget> {
  late BackDoorDeliveryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BackDoorDeliveryModel());
                  ...
                  children: [
                    Expanded(
                      child: Align(
                        ...
                        child: Builder(
                          builder: (context) {
                            final listaProductos = FFAppState()
                                .productosEscaneadosEnElDia
                                .toList();
                            ...
                            return ListView.separated(
                              ...
                              itemBuilder: (context, listaProductosIndex) {
                                final listaProductosItem =
                                    listaProductos[listaProductosIndex];
                                return Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      30.0, 0.0, 30.0, 0.0),
                                  child: Container(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (_model.sinputSkuTextController.text !=
                                              '') {
                                        _model.resultadoSKUBusqueda =
                                            await ApiShelfGroup
                                                .searchProductCall
                                                .call(
                                        ...
                                        if (ProductsStruct.maybeFromMap((_model
                                          ...
                                          _shouldSetState = true;
                                          FFAppState()
                                              .addToProductosEscaneadosEnElDia(
