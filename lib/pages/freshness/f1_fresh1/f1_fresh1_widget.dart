...
import 'f1_fresh1_model.dart';
export 'f1_fresh1_model.dart';

class F1Fresh1Widget extends StatefulWidget {
  const F1Fresh1Widget({super.key});

  static String routeName = 'F1_FRESH1';
  static String routePath = '/f1Fresh1';

  @override
  State<F1Fresh1Widget> createState() => _F1Fresh1WidgetState();
}

class _F1Fresh1WidgetState extends State<F1Fresh1Widget> {
  late F1Fresh1Model _model;
                                              ...
                                              children: [
                                                ...
                                                Expanded(
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        'Category: ${listPlanogramItem.category1}',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyMedium
                                                      ...
                                                      Text(
                                                        'Type Display: ${listPlanogramItem.type}',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyMedium
                                              ...
                                              Expanded(
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    ...
                                                    context.pushNamed(
                                                        FRESH2ProductsWidget
                                                            .routeName);
                                                  },
                                                  text: 'SHELF LIFE AUDIT',
