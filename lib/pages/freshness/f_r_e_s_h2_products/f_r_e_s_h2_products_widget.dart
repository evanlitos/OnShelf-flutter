...
import '/pages/alerts/damage/damage_widget.dart';
...
import 'f_r_e_s_h2_products_model.dart';
export 'f_r_e_s_h2_products_model.dart';

class FRESH2ProductsWidget extends StatefulWidget {
  const FRESH2ProductsWidget({super.key});

  static String routeName = 'FRESH2_Products';
  static String routePath = '/fRESH2Products';

  @override
  State<FRESH2ProductsWidget> createState() => _FRESH2ProductsWidgetState();
}

class _FRESH2ProductsWidgetState extends State<FRESH2ProductsWidget> {
  late FRESH2ProductsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FRESH2ProductsModel());
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final items =
                          FFAppState().ShelfSelected.products.toList();
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    Text(
                                                      'No. Panogram: ${FFAppState().ShelfSelected.mapCanvaId.toString()}',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyMedium
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 10.0, 0.0, 0.0),
                                            child: Text(
                                              functions.constructExpirations(
                                                  itemsItem.toMap()),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                            ...
                            child: Row(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      FFAppState().updateShelfSelectedStruct(
                                        (e) => e
                                          ..finishedAt =
                                          ...
                                          ..storeId =
                                              FFAppState().routeOfDay.storeId
                                          ..merchandizerId =
                                              FFAppState().user.user.id,
                                      );
                                      safeSetState(() {});
                                      await actions.initLog(
                                        'Entrada',
                                      );
                                      await actions.initLog(
                                        'Llamada',
                                      ...
                                      _model.shipfresh = await ApiShelfGroup
                                          .freshnessCall
                                          .call(
                                        token: FFAppState().user.token,
                                        shelfJson: getJsonField(
                                          FFAppState().ShelfSelected.toMap(),
                                          r'''$''',
                                        ),
                                      );
