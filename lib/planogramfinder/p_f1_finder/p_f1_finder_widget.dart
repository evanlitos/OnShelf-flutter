...
export 'p_f1_finder_model.dart';

class PF1FinderWidget extends StatefulWidget {
  const PF1FinderWidget({super.key});

  static String routeName = 'PF1_finder';
  static String routePath = '/pF1Finder';

  @override
  State<PF1FinderWidget> createState() => _PF1FinderWidgetState();
}

class _PF1FinderWidgetState extends State<PF1FinderWidget> {
  late PF1FinderModel _model;
