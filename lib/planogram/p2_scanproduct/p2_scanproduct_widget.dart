...
class _P2ScanproductWidgetState extends State<P2ScanproductWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().update(() {});
      while (_model.loop < widget.numRows!) {
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    final testRows = functions
                                        .buildRowList(widget.numRows!)
                                        .toList();
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder: (context, testRowsIndex) {
                                        final testRowsItem =
                                            testRows[testRowsIndex];
                                        return Container(
                                          width: 100.0,
                                          height: (widget.shelfHeightCM!) *
                                              _model.factorEscala *
                                              1.0,
                                          decoration: BoxDecoration(
                                            color: FlutterFlowTheme.of(context)
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      if ((_model.rows.isNotEmpty) == true) {
                                        _model.updateRowsAtIndex(
                                          _model.indiceActual,
                                          (e) => e
                                            ..updateProducts(
                                              (e) => e.add(ProductListRowStruct(
                                                productId: 936,
                                                position: 0,
                                                quantity: 1,
                                                height: 50,
