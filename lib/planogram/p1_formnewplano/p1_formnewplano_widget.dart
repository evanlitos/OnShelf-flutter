...
import 'p1_formnewplano_model.dart';
export 'p1_formnewplano_model.dart';

class P1FormnewplanoWidget extends StatefulWidget {
  const P1FormnewplanoWidget({super.key});

  static String routeName = 'P1_FORMNEWPLANO';
  static String routePath = '/p1Formnewplano';

  @override
  State<P1FormnewplanoWidget> createState() => _P1FormnewplanoWidgetState();
}

class _P1FormnewplanoWidgetState extends State<P1FormnewplanoWidget> {
  late P1FormnewplanoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P1FormnewplanoModel());
    ...
    _model.pWitdtjTextController ??= TextEditingController();
    _model.pWitdtjFocusNode ??= FocusNode();

    _model.pHeightTextController ??= TextEditingController();
    _model.pHeightFocusNode ??= FocusNode();

    _model.pRowsTextController ??= TextEditingController();
    _model.pRowsFocusNode ??= FocusNode();

    _model.pDepthTextController ??= TextEditingController();
    _model.pDepthFocusNode ??= FocusNode();
  }
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: _model.pNameTextControllerValidator
                                      .asValidator(context),
                                  inputFormatters: [
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    cursorColor: FlutterFlowTheme.of(context)
                                        .primaryText,
                                    validator: _model
                                        .pWitdtjTextControllerValidator
                                        .asValidator(context),
                                    inputFormatters: [
                                      FilteringTextInputFormatter.allow(
                                          RegExp('[0-9]'))
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    cursorColor: FlutterFlowTheme.of(context)
                                        .primaryText,
                                    validator: _model
                                        .pHeightTextControllerValidator
                                        .asValidator(context),
                                    inputFormatters: [
                                      FilteringTextInputFormatter.allow(
                                          RegExp('[0-9]'))
