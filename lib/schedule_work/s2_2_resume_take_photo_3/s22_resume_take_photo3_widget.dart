...
export 's22_resume_take_photo3_model.dart';

class S22ResumeTakePhoto3Widget extends StatefulWidget {
  const S22ResumeTakePhoto3Widget({
    super.key,
    required this.foto,
  });
  ...
  static String routeName = 'S2_2_Resume_TakePhoto_3';
  static String routePath = '/s22ResumeTakePhoto3';

  @override
  State<S22ResumeTakePhoto3Widget> createState() =>
      _S22ResumeTakePhoto3WidgetState();
}

class _S22ResumeTakePhoto3WidgetState extends State<S22ResumeTakePhoto3Widget> {
  late S22ResumeTakePhoto3Model _model;
