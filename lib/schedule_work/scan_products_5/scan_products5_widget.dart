...
import 'scan_products5_model.dart';
export 'scan_products5_model.dart';

class ScanProducts5Widget extends StatefulWidget {
  const ScanProducts5Widget({super.key});

  @override
  State<ScanProducts5Widget> createState() => _ScanProducts5WidgetState();
}

class _ScanProducts5WidgetState extends State<ScanProducts5Widget> {
  late ScanProducts5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScanProducts5Model());
            ...
            children: [
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final items = _model.nItems.toList();
                                              ...
                                              return Dialog(
                                                ...
                                                child: GestureDetector(
                                                  onTap: () => FocusScope.of(
                                                      ...
                                                      .unfocus(),
                                                  child:
                                                      const NotScannerProductsWidget(),
                                                ),
                                              );
                                            },
                                          );
