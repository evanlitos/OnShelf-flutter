...
import 's1_block_categories2_model.dart';
export 's1_block_categories2_model.dart';

class S1BlockCategories2Widget extends StatefulWidget {
  const S1BlockCategories2Widget({super.key});

  static String routeName = 'S1_BLOCK_CATEGORIES2';
  static String routePath = '/s1BlockCategories2';

  @override
  State<S1BlockCategories2Widget> createState() =>
      _S1BlockCategories2WidgetState();
}

class _S1BlockCategories2WidgetState extends State<S1BlockCategories2Widget> {
  late S1BlockCategories2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => S1BlockCategories2Model());
                          ...
                          builder: (context) {
                            ...
                            return RefreshIndicator(
                              ...
                              child: ListView.separated(
                                ...
                                itemCount: shelfsOfDay.length,
                                separatorBuilder: (_, __) =>
                                    SizedBox(height: 10.0),
                                itemBuilder: (context, shelfsOfDayIndex) {
                                  final shelfsOfDayItem =
                                      shelfsOfDay[shelfsOfDayIndex];
                                  return Container(
                                    width:
                                                  ...
                                                  Expanded(
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        ...
                                                        context.pushNamed(
                                                            S2BlockCategoriesInstructionsWidget
                                                                .routeName);
                                                      },
                                                      text: 'CONTINUE',
