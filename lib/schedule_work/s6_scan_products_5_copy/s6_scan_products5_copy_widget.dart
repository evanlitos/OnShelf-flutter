...
import 's6_scan_products5_copy_model.dart';
export 's6_scan_products5_copy_model.dart';

class S6ScanProducts5CopyWidget extends StatefulWidget {
  const S6ScanProducts5CopyWidget({
    super.key,
    required this.aFoto,
    required this.bFoto,
  });
  ...
  static String routeName = 'S6_ScanProducts_5Copy';
  static String routePath = '/s6ScanProducts5Copy';

  @override
  State<S6ScanProducts5CopyWidget> createState() =>
      _S6ScanProducts5CopyWidgetState();
}

class _S6ScanProducts5CopyWidgetState extends State<S6ScanProducts5CopyWidget> {
  late S6ScanProducts5CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => S6ScanProducts5CopyModel());
