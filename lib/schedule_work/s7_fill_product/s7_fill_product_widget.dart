...
import 's7_fill_product_model.dart';
export 's7_fill_product_model.dart';

class S7FillProductWidget extends StatefulWidget {
  const S7FillProductWidget({
    super.key,
    this.product,
  ...
  static String routeName = 'S7_FillProduct';
  static String routePath = '/s7FillProduct';

  @override
  State<S7FillProductWidget> createState() => _S7FillProductWidgetState();
}

class _S7FillProductWidgetState extends State<S7FillProductWidget> {
  late S7FillProductModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => S7FillProductModel());
